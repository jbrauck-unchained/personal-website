...
export default function About() {
  ...
  return (
    <section id="about" className="py-48 px-6 lg:px-12 bg-[var(--bg-primary)]" ref={ref}>
        ...
        <div className={`reveal ${isVisible ? "is-visible" : ""}`}>
          ...
          <div className="grid lg:grid-cols-12 gap-24 mb-32">
            <div className="lg:col-span-7">
              <div className="mb-24 pb-24 border-b-2 border-[var(--border-color)]">
                <h3 className="text-2xl font-bold mb-12 uppercase tracking-wide">
                  Product Manager Who Codes
                </h3>
                <p className="text-[var(--text-primary)] mb-12 leading-relaxed">
