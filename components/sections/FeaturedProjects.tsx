const chapters = [
  ...
  },
  {
    ...
    body: "Led native iOS and Android product work, including the Android launch, vault spending on iOS, and cross-platform release systems.",
  ...
  },
  {
    ...
    body: "Led work on Signing Stack that increased daily signature capacity from about 50 to thousands, then moved to mobile.",
  ...
  },
  {
    ...
    role: "QA Engineer",
    body: "Managed releases and built test infrastructure, including Playwright.",
  ...
  },
  {
    ...
    body: "Triaged bugs, ran acceptance tests, and worked through client-facing product issues.",
