  ...
  const experiences = [
    {
      ...
      achievements: [
        ...
        {
          text: "Shipped vault spending feature enabling users to send Bitcoin from multisig vaults on iOS",
          highlight: true,
        },
        {
    ...
    },
    {
      ...
      achievements: [
        ...
        {
          text: "Expanded daily signature capacity from ~50 to thousands, enabling Unchained to scale to the next 10000 users",
          highlight: true,
        },
        {
    ...
    },
    {
      ...
      achievements: [
        ...
        {
          text: "Improved Test Bridge API to generate testing data in development environments, accelerating QA workflows",
          highlight: false,
        },
        {
      ...
      <div className="container mx-auto max-w-5xl">
        ...
        >
          ...
          <p className="text-center text-gray-600 dark:text-gray-400 mb-12 max-w-2xl mx-auto">
            From QA Support Engineer to Product Manager—nearly 4 years of growth
            leveraging technical depth to ship impactful products
          </p>
          ...
          >
            <div className="bg-white dark:bg-gray-800 border-4 border-bitcoin-500 p-6 rounded-lg text-center shadow-lg">
              <div className="text-4xl font-bold mb-2 text-bitcoin-600 dark:text-bitcoin-400">
                4 Roles
              </div>
              <div className="text-gray-700 dark:text-gray-300">
                QA Support → QA → APM → PM in Under 4 Years
              </div>
            </div>
            <div className="bg-white dark:bg-gray-800 border-4 border-orange-500 p-6 rounded-lg text-center shadow-lg">
              ...
              <div className="text-gray-700 dark:text-gray-300">
                Daily Signature Capacity Scaled
              </div>
            </div>
            <div className="bg-white dark:bg-gray-800 border-4 border-bitcoin-500 p-6 rounded-lg text-center shadow-lg">
              <div className="text-4xl font-bold mb-2 text-bitcoin-600 dark:text-bitcoin-400">
